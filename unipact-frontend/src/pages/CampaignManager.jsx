...
const CompanyDashboard = () => {
  ...
  // MOCK DATA: Campaigns sorted by Lifecycle
  const campaigns = [
    { 
      id: 1, 
      ...
      description: 'Looking for a comprehensive social media strategy targeting students.'
    },
    { 
      id: 2, 
      title: 'AI Model Data Collection', 
      budget: 'RM 500', 
      applicants: 4, 
      status: 'recruiting', 
      deadline: '5 Days Left',
      description: 'Need students to record voice samples for AI training.'
    },
    { 
      id: 3, 
      title: 'Campus Roadshow Ambassador', 
      budget: 'RM 2,000', 
      guild: 'Tech Society USM', 
      status: 'active', 
      progress: '45%', 
      description: 'Physical booth setup and flyer distribution at USM.'
    },
    { 
      id: 4, 
      ...
      status: 'completed', 
      rating: 'S', 
      description: 'Bug reporting and UX feedback for v2.0 launch.'
    }
  ];
    ...
    <div className="min-h-screen bg-[var(--bg-void)] p-6">
      ...
      <nav className="flex justify-between items-center mb-8 bg-[var(--bg-panel)] p-4 border border-[var(--border-tech)] shadow-lg">
        ...
        <div className="flex items-center gap-4 text-sm text-[var(--text-blue)]">
          ...
          <span className="hover:text-[var(--text-gold)] cursor-pointer">Settings</span>
          ...
          <div className="space-y-4">
            {filteredCampaigns.length > 0 ? (
              filteredCampaigns.map((camp) => (
                <div key={camp.id} className="bg-black/20 border border-transparent hover:border-[var(--text-gold)] p-4 transition-all group">
                  <div className="flex justify-between items-start mb-2">
                    <div>
